#include "PlanarPhysics/CollisionHandlers/RigidBodyBallCH.h"
#include "PlanarPhysics/PlanarObjects/Ball.h"
#include "PlanarPhysics/PlanarObjects/RigidBody.h"
#include "PlanarPhysics/Math/Utilities/LineSegment.h"
	...
	for (int i = 0; i < worldPolygon.GetVertexCount(); i++)
	{
		...
		if (distance < ball->radius)
		{
			...
			if (relativeVelocity < 0.0)
			{
				...
				double coefficientOfRestitution = ball->GetBounceFactor() * body->GetBounceFactor();
