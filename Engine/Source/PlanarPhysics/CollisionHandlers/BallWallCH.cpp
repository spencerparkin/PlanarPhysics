#include "PlanarPhysics/CollisionHandlers/BallWallCH.h"
#include "PlanarPhysics/PlanarObjects/Ball.h"
...
/*virtual*/ bool BallWallCH::HandleCollision(PlanarObject* objectA, PlanarObject* objectB)
{
	...
	double coefficientOfRestitution = ball->GetBounceFactor() * wall->GetBounceFactor();
	double impulseMag = (1.0 + coefficientOfRestitution) * ::fabs(relativeVelocity);
